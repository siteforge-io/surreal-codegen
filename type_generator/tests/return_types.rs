...
use surrealdb::sql::{Kind, Table};
use type_generator::{step_2_interpret_query::QueryReturnType, step_3_outputs::CodegenInformation};
...
"#;
    ...
    assert_eq!(codegen_info, CodegenInformation {
...
"#;
    ...
    assert_eq_sorted!(codegen_info, CodegenInformation {
        parameters: HashMap::new(),
        return_types: vec![
...
"#;
    ...
    assert_eq_sorted!(codegen_info, CodegenInformation {
        parameters: [
            ("user".into(), Kind::Record([Table::from("user")].into()))
        ].into(),
        return_types: vec![
            QueryReturnType::Array(Box::new(QueryReturnType::Object([
                ("name".into(), QueryReturnType::String.into()),
...
"#;
    ...
    assert_eq_sorted!(codegen_info, CodegenInformation {
        parameters: HashMap::new(),
        return_types: vec![
            QueryReturnType::Array(Box::new(
                QueryReturnType::Object([
                    ("xyz".into(), Box::new(QueryReturnType::Object([
                        ("abc".into(), QueryReturnType::String.into()),
                        ("user".into(), Box::new(QueryReturnType::Object([
                            ("xyz".into(), Box::new(QueryReturnType::Record([Table::from("user")].into()))),
                        ].into()))),
                    ].into()))),
                ].into())
            )),
...
"#;
    ...
    assert_eq_sorted!(codegen_info, CodegenInformation {
        ...
        return_types: vec![
            QueryReturnType::Object([
                ("foo".into(), QueryReturnType::String.into()),
            ].into()),
        ]
    });
...
"#;
    ...
    assert_eq_sorted!(codegen_info, CodegenInformation {
        ...
        return_types: vec![
            QueryReturnType::Object([
                ("name".into(), QueryReturnType::Option(Box::new(QueryReturnType::String.into())).into()),
                ("num".into(), QueryReturnType::Option(Box::new(QueryReturnType::Int.into())).into()),
                ("bool".into(), QueryReturnType::Option(Box::new(QueryReturnType::Bool.into())).into()),
                ("datetime".into(), QueryReturnType::Option(Box::new(QueryReturnType::Datetime.into())).into()),
                ("duration".into(), QueryReturnType::Option(Box::new(QueryReturnType::Duration.into())).into()),
                ("decimal".into(), QueryReturnType::Option(Box::new(QueryReturnType::Decimal.into())).into()),
                ("xyz".into(), QueryReturnType::Option(Box::new(QueryReturnType::Object([
                    ("abc".into(), QueryReturnType::Option(Box::new(QueryReturnType::String.into())).into()),
                ].into()))).into()),
            ].into()),
        ]
    });
